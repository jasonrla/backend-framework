...
describe('Authorization declined', () => {
    ...
    data.forEach(({ amount, merchantCountry, merchantCurrency, merchantAmount, provider, xbFeeRateExpected }) => {
        ...
        test('Authenticate with a user token', async () => {
            const requestBody = {
                "username": "jason.lopez+dev_mx_admin_z0pn8@tribal.credit",
        ...
        test('Get card Id', async () => {
            ...
            const sqlQuery = 'SELECT * FROM user_card_balance WHERE customer_id = $1 and user_id = $2 and period_month = $3 and period_year = $4';
...
describe('Calculate XB fees', () => {
 
    const dataSettledCard = [
        { 
            username: 'jason.lopez+dev_us_super_admin_1w4rc@tribal.credit',
            amount: 1900,
            merchantCountry: 'MX',
            merchantCurrency: 'MXN',
            merchantAmount: 111,
        ...
        { 
            username: 'jason.lopez+dev_mx_user_56842@tribal.credit',
            amount: 1900,
            merchantCountry: 'US',
            merchantCurrency: 'MXN',
            merchantAmount: 111,
    ...
    dataSettledCard.forEach(({ username, amount, merchantCountry, merchantCurrency, merchantAmount, provider, xbFeeRateExpected }) => {
        ...
        test('Get card Id', async () => {
            ...
            const sqlQuery = 'SELECT * FROM user_card_balance WHERE customer_id = $1 and period_month = $2 and period_year = $3';
            const queryParams = [customerId, currentMonth, currentYear];
